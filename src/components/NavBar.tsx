...
function NavBar({darkMode, setDarkMode, visibleButton, setVisibleButton}: navProps) {

    let fullScreenEvent: () => void;
    ...
    return(
        <nav className="navBar">
            <button className={"navIcon"} onClick = {()=>  {setDarkMode(!darkMode)}}>
