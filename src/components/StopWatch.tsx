...
type stopWatchProps = {
    ...
    setVisibleButton : React.Dispatch<React.SetStateAction<boolean>>;
};
...
function StopWatch({darkMode, setDarkMode, recordList, setRecordList, visibleButton, setVisibleButton} : stopWatchProps) {
    ...
    function deleteRecord(recordID : string) {
        const newRecords = recordList.filter((record:string[]) => record[0] != recordID);
            ...
            <div className="stopWatchDisplay">
                ...
                <div className="buttonContainer">
                    {visibleButton && <div className={"progressButtons"}>
                        ...
                        <button onClick={() => {setRecordList((prev : string[][]) => [...prev, [timeHMS(time-prevStopWatch.current), timeHMS(time)]]); prevStopWatch.current = time; recordID.current += 1;}}>
